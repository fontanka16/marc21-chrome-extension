// Vanliga MARC21-fält (bibliografiska + bestånd) – engelska etiketter från Library of Congress.
// Inte en komplett lista; okända fält visas bara med sin kod.
...
export const FIELD_LABELS = {
  ...
  "859": "Local Data Field (Libris-specific)",
...
/**
 * Hämta en läsbar etikett för ett MARC-taggnummer. Faller tillbaka på tom sträng.
 * @param {string} tag
 * @returns {string}
 */
export function labelFor(tag) {
  return FIELD_LABELS[tag] || "";
}
